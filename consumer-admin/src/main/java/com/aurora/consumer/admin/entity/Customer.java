...
public class Customer implements Serializable{
	...
	private static final long serialVersionUID = 1L;
		 ...
		 * 更新日期
		 */
		private String updateSalesmanDate;
		/**
		 * 用户总购买金额
		 */
		...
		/**
		 * 获取: updateSalesmanDate
		 * @return the updateSalesmanDate
		 */
		public String getUpdateSalesmanDate() {
			return updateSalesmanDate;
		}
		/**
		 * 设置: updateSalesmanDate
		 * @param updateSalesmanDate the updateSalesmanDate to set
		 */
		public void setUpdateSalesmanDate(String updateSalesmanDate) {
			this.updateSalesmanDate = updateSalesmanDate;
		}
		/**
		 * 获取: totalBuyMoney
